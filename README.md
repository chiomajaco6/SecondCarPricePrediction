...
## Conclusion
Overall, the best model for predicting the car prices was the Random Forest model, with a R2 score of 88.12%. The neural network powered by MLPRegressor model had a R2 score of 73.34%, while the SVR model had a a R2 score of 70.23%
